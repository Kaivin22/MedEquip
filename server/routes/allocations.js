...
router.post("/", authMiddleware, roleMiddleware("ADMIN", "NV_KHO", "QL_KHO"), createAllocation);
...
router.put("/:id/extend-approve", authMiddleware, roleMiddleware("ADMIN", "NV_KHO", "QL_KHO"), extendApprove);
