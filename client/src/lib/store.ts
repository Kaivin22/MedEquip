import { NguoiDung, ThietBi, TonKho, NhaCungCap, Khoa, ThongBao, PhieuYeuCauCapPhat, PhieuXuatKho, PhieuNhapKho, PhieuCapPhat, PhieuBaoHuHong, PhieuYeuCauNhap, PhieuTra } from '@/types';
...
export const store = {
  ...
  getReturns: () => getStore<PhieuTra>('kho_returns', []),
  setReturns: (d: PhieuTra[]) => setStore('kho_returns', d),
